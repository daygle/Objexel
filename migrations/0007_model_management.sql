ALTER TABLE models
    ADD COLUMN IF NOT EXISTS model_type TEXT NOT NULL DEFAULT 'yolo',
    ADD COLUMN IF NOT EXISTS input_width INTEGER NOT NULL DEFAULT 640,
    ADD COLUMN IF NOT EXISTS input_height INTEGER NOT NULL DEFAULT 640,
    ADD COLUMN IF NOT EXISTS class_list JSONB NOT NULL DEFAULT '[]',
    ADD COLUMN IF NOT EXISTS enabled BOOLEAN NOT NULL DEFAULT TRUE,
    ADD COLUMN IF NOT EXISTS default_model BOOLEAN NOT NULL DEFAULT FALSE;
